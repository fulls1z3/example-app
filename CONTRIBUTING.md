# Contributing to ng-seed/spa

We would love for you to contribute to **`ng-seed/spa`** and help make it even better than it is today! As a contributor,
...
Help us keep **`ng-seed/spa`** open and inclusive. Please read and follow our [Code of Conduct][coc].
...
You can file new issues by filling out our [new issue form](https://github.com/ng-seed/spa/issues/new).

### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/ng-seed/spa/pulls) for an open or closed PR that relates to your submission.
...
* Push your branch to GitHub:
    ...
    ```
* In GitHub, send a pull request to `spa:master`.
...
Samples: (even more [samples](https://github.com/ng-seed/spa/commits/master))
```
...
[coc]: https://github.com/ng-seed/spa/blob/master/CODE_OF_CONDUCT.md
[github]: https://github.com/ng-seed/spa
